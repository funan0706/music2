...
public class AutoGenerator {
    ...
    // 数据库
    private static final String URL = "jdbc:mysql://localhost:3306/music?characterEncoding=UTF-8&serverTimezone=UTC";
...
//                            .fileOverride();            //开启覆盖之前生成的文件
                ...
                .packageConfig(builder -> {
                    // 填入包名
                    builder.parent("com.example.music2")
